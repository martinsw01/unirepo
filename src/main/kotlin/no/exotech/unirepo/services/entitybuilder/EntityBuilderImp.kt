...
class EntityBuilderImp(private val emptyEntityBuilder: EmptyEntityBuilder) : EntityBuilder {

    override fun <Entity> createEntitiesOfResultSet(rs: ResultSet, clazz: Class<Entity>): List<Entity> {
